...
router.get('/faq', (ctx) => {
  const qas = {
    ...
    "What's your privacy policy?": 'Everything you send here is yours forever. You can delete it completely and know it won\'t be around anymore in any place. Data is not shared with third parties, nor read by first parties. The website does not use any external dependencies, anything you write here will only be visible to you and your trustee.',
